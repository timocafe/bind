...
namespace ambient { namespace numeric { namespace kernels {
    ...
    AMBIENT_STATIC_BIND_TEMPLATE(detail::geqrt, geqrt)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::ormqr, ormqr)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::tsqrt, tsqrt)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::tsmqr, tsmqr)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::gelqt, gelqt)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::ormlq, ormlq)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::tslqt, tslqt)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::tsmlq, tsmlq)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::gemm,  gemm)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::gemm_fma, gemm_fma)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::gemm_diagonal_lhs, gemm_diagonal_lhs)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::gemm_diagonal_rhs, gemm_diagonal_rhs)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::gemm_diagonal, gemm_diagonal)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::trace, trace)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::scalar_norm, scalar_norm)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::overlap, overlap)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::add, add)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::sub, sub)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::scale, scale)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::scale_offset, scale_offset)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::scale_inverse, scale_inverse)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::sqrt_diagonal, sqrt_diagonal)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::exp_diagonal, exp_diagonal)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::transpose_out,transpose_out)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::conj_inplace, conj_inplace)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::resize, resize)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::init_identity, init_identity)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::init_value, init_value)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::round_square, round_square)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::cast_to_vector, cast_to_vector)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::cast_from_vector, cast_from_vector)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::cast_from_vector_t, cast_from_vector_t)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::cast_double_complex, cast_double_complex)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::touch, touch)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::migrate, migrate)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::hint, hint)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::svd, svd)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::inverse, inverse)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::geev, geev)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::heev, heev)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::copy_rt, copy_rt)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::copy_lt, copy_lt)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::copy_block_unbound, copy_block_unbound)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::copy_block_s_unbound, copy_block_s_unbound)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::copy_block, copy_block)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::copy_block_s, copy_block_s)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::copy_block_sa, copy_block_sa)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::init_random, init_random)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::init_random_hermitian, init_random_hermitian)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::validation, validation)
