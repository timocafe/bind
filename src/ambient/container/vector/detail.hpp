...
namespace ambient {
    ...
    AMBIENT_STATIC_BIND_TEMPLATE(detail::set_size,          set_size)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::measure_size,      measure_size)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::init_value_vector, init_value_vector)
    AMBIENT_STATIC_BIND_TEMPLATE(detail::copy_vector,       copy_vector)
